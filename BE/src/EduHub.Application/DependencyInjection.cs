...
using EduHub.Application.Services.Analytics;
...
using EduHub.Application.Services.Monitoring;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IAdminAnalyticsSnapshotService, AdminAnalyticsSnapshotService>();
        services.AddScoped<IAdminAnalyticsReportService, AdminAnalyticsReportService>();
